...
# declare output file
outfile = open('fb_dev_slots.txt','w')
# split into strings with more than 3 newlines
result = re.split(r'\s{3,}', input)

for s in result:
    # replace newline with space and convert label to O
    spaced = s.replace('\n', ' ')
    result = spaced.replace('NoLabel', 'O')
